...
class Auth:
    ...
    def create_session(self, email: str) -> str:
        """Creates a new session for the user with the
            given email and returns the session ID.
        """
        try:
    ...
    def destroy_session(self, user_id: int) -> None:
        """
            to destroy the session it update the session_id
            to None
        """
    ...
    def update_password(self, reset_token: str, password: str) -> None:
        ...
        try:
            ...
            _hash_password = _hash_password(password)
            self._db.update_user(user.id, _hashed_password=_hash_password,
                                 reset_token=None)
